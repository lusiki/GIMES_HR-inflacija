...
Ovaj dokument konstruira semantičke indekse geopolitičke nestabilnosti temeljene na analizi medijskog diskursa. Indeksi mjere intenzitet, sentiment i neizvjesnost vezanu uz geopolitičke događaje, sukobe i međunarodne odnose.
...
# Geopolitički sentiment leksikon (eskalacija vs deeskalacija)
...
# Geopolitička neizvjesnost leksikon
...
# Forward looking (prognostički) leksikon
forward_lexicon <- c(
  # Očekivanja
...
# Eskalacija vs Deeskalacija analiza
...
## Uncertainty vs Escalation scatter
...
ggplot(monthly, aes(x = GUI, y = ESI)) +
  ...
  labs(
    title = "Neizvjesnost vs Eskalacija",
...
*GIMES Research | Semantički indeks geopolitičke nestabilnosti v1.0*
